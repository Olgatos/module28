...
def test_auth_by_valid_phone():
   ...
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.ID, "username"))).send_keys("89001546125")
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.ID, "password"))).send_keys("Test_parol")
   try:
...
def test_auth_by_invalid_phone():
   ...
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.ID, "username"))).send_keys("80009008070")
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.ID, "password"))).send_keys("Test_parol_2")
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.ID, "kc-login"))).click()
   # assert pytest.driver.save_screenshot('auth_by_valid_phone.png')
...
def test_auth_by_valid_mail():
   ...
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.ID, "username"))).send_keys("ostkaf904@yandex.ru")
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.ID, "password"))).send_keys("Test_parol_3")
   try:
      WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.ID, "kc-login"))).click()
...
def test_auth_by_invalid_mail():
   ...
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.ID, "username"))).send_keys("ostkaf9045@yandex.ru")
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.ID, "password"))).send_keys("Test_parol_4")
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.ID, "kc-login"))).click()
   # assert pytest.driver.save_screenshot('auth_by_valid_phone.png')
   assert WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.ID, "form-error-message")))
...
def test_auth_by_invalid_login():
   ...
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.ID, "password"))).send_keys("Test_parol_5")
...
def test_auth_by_invalid_ls():
   ...
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.ID, "username"))).send_keys("000012300456")
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.ID, "password"))).send_keys("Test_parol_6")
   try:
...
def test_auth_code_link_by_mail():
   ...
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.ID, "address"))).send_keys("os-tarasenko@yandex.ru")
   ...
   try:
      ...
      assert WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.CLASS_NAME, "otp-code-form-container__desc"))).text == "На почту os-tarasenko@yandex.ru"
   except:
...
def test_auth_code_link_by_phone():
   ...
   pytest.driver.get('https://b2c.passport.rt.ru/auth/realms/b2c/protocol/openid-connect/auth?client_id=lk_decosystems&redirect_uri=https://start.rt.ru/&response_type=code&scope=openid&theme=light')
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.ID, "address"))).send_keys("+79263812349")
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.ID, "otp_get_code"))).click()
   try:
      assert WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.TAG_NAME, "h1"))).text == "Код подтверждения отправлен"
...
def test_register_by_mail():
   ...
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.ID, "address"))).send_keys("ostkaf904@yandex.ru")
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.ID, "password"))).send_keys("Test_parol_7")
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.ID, "password-confirm"))).send_keys("Test_parol_7")
...
def test_register_by_phone():
   ...
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.NAME, "firstName"))).send_keys("Иван")
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.NAME, "lastName"))).send_keys("Иванов")
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.ID, "address"))).send_keys("89263812349")
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.ID, "password"))).send_keys("Test_parol_7")
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.ID, "password-confirm"))).send_keys("Test_parol_7")
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.NAME, "register"))).click()
...
def test_register_firstname_check():
   ...
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.NAME, "firstName"))).send_keys("Valeria")
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.NAME, "register"))).click()
   assert WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.XPATH, '//form/div[1]/div[1]/span'))).text == 'Необходимо заполнить поле кириллицей. От 2 до 30 символов.'
   # time.sleep(5)
   pytest.driver.refresh()
   ...
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.NAME, "firstName"))).send_keys("моеимяфамилия")
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.NAME, "register"))).click()
   assert WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.XPATH, '//form/div[1]/div[1]/span'))).text == 'Необходимо заполнить поле кириллицей. От 2 до 30 символов.'
   # time.sleep(5)
   pytest.driver.refresh()

   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.NAME, "firstName"))).send_keys("Ольга_Ольга")
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.NAME, "register"))).click()
   assert WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.XPATH, '//form/div[1]/div[1]/span'))).text == 'Необходимо заполнить поле кириллицей. От 2 до 30 символов.'
   # time.sleep(5)
   pytest.driver.refresh()

   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.NAME, "firstName"))).send_keys("1234567")
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.NAME, "register"))).click()
   assert WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.XPATH, '//form/div[1]/div[1]/span'))).text == 'Необходимо заполнить поле кириллицей. От 2 до 30 символов.'
   # time.sleep(5)
...
def test_register_lastname_check():
   ...
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.NAME, "lastName"))).send_keys("Valeria")
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.NAME, "register"))).click()
   assert WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.XPATH, '//form/div[1]/div[2]/span'))).text == 'Необходимо заполнить поле кириллицей. От 2 до 30 символов.'
   # time.sleep(5)
   pytest.driver.refresh()
   ...
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.NAME, "lastName"))).send_keys("моеимяфамилия")
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.NAME, "register"))).click()
   assert WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.XPATH, '//form/div[1]/div[2]/span'))).text == 'Необходимо заполнить поле кириллицей. От 2 до 30 символов.'
   # time.sleep(5)
   pytest.driver.refresh()

   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.NAME, "lastName"))).send_keys("Лермонтов")
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.NAME, "register"))).click()
   assert WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.XPATH, '//form/div[1]/div[2]/span'))).text == 'Необходимо заполнить поле кириллицей. От 2 до 30 символов.'
   # time.sleep(5)
   pytest.driver.refresh()
...
def test_register_mail_phone_check():
   ...
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.ID, "address"))).send_keys("моеимяфамилия")
   WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.NAME, "register"))).click()
   assert WebDriverWait(pytest.driver, 10).until(EC.presence_of_element_located((By.XPATH, '//div/div/div/form/div[3]/span'))).text == 'Введите телефон в формате +7ХХХХХХХХХХ или +375XXXXXXXXX, или email в формате example@email.ru'
   # time.sleep(5)
   pytest.driver.refresh()
